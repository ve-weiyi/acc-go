...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		db:         db,
		TbUserAuth: newTbUserAuth(db, opts...),
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		db:         db,
		TbUserAuth: q.TbUserAuth.clone(db),
...
func (q *Query) ReplaceDB(db *gorm.DB) *Query {
	return &Query{
		db:         db,
		TbUserAuth: q.TbUserAuth.replaceDB(db),
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		TbUserAuth: q.TbUserAuth.WithContext(ctx),
