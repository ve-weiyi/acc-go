...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&entity.UserInfo{})
	...
	_user.Sex = field.NewUint(tableName, "sex")
...
func (u userDo) Create(values ...*entity.UserInfo) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*entity.UserInfo, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*entity.UserInfo) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*entity.UserInfo, error) {
...
func (u userDo) Take() (*entity.UserInfo, error) {
...
func (u userDo) Last() (*entity.UserInfo, error) {
...
func (u userDo) Find() ([]*entity.UserInfo, error) {
	result, err := u.DO.Find()
	return result.([]*entity.UserInfo), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.UserInfo, err error) {
...
func (u userDo) FindInBatches(result *[]*entity.UserInfo, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*entity.UserInfo, error) {
...
func (u userDo) FirstOrCreate() (*entity.UserInfo, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*entity.UserInfo, count int64, err error) {
...
func (u userDo) Delete(models ...*entity.UserInfo) (result gen.ResultInfo, err error) {
